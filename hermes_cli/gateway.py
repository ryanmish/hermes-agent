...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            "1. Create a SendBlue account at https://sendblue.co/",
            "2. Get your API Key and API Secret from the SendBlue dashboard",
            "3. Configure your from-number (the number SendBlue provisions for you)",
            "4. Set up your webhook URL for inbound iMessages:",
            "   SendBlue Dashboard → Settings → Webhooks → https://your-server:8646/webhooks/sendblue",
        ],
        "vars": [
            {"name": "SENDBLUE_API_KEY", "prompt": "SendBlue API Key", "password": False,
             "help": "Found on the SendBlue dashboard (sb-api-key-id)."},
            {"name": "SENDBLUE_API_SECRET", "prompt": "SendBlue API Secret", "password": True,
             "help": "Found on the SendBlue dashboard (sb-api-secret-key)."},
            {"name": "SENDBLUE_FROM_NUMBER", "prompt": "SendBlue from-number (E.164 format, e.g. +14025551234)", "password": False,
             "help": "The phone number provisioned by SendBlue for sending iMessages."},
            {"name": "SENDBLUE_ALLOWED_USERS", "prompt": "Allowed phone numbers (comma-separated, E.164 format)", "password": False,
             "is_allowlist": True,
             "help": "Only messages from these phone numbers will be processed."},
            {"name": "SENDBLUE_HOME_CHANNEL", "prompt": "Home channel phone number (for cron/notification delivery, or empty)", "password": False,
             "help": "Phone number to deliver cron job results and notifications to."},
        ],
    },
    {
